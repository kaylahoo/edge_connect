...
class InpaintGenerator(BaseNetwork):
    ...
    def __init__(self, image_in_channels=4, edge_in_channels=4, out_channels=3, init_weights=True):
        ...
        self.dc_structure_1 = DepConvBNActiv(64, 64, groups=64)
